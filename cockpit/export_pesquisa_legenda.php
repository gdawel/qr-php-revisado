...
function renderListValues($title, $ds) {
	echo "<h2>".utf8_decode($title)."</h2>";
	
	echo "<table border='1'>
				<tr><th>Valor</th><th>Texto</th></tr>";
	foreach ($ds as $r) echo "<tr><td style=\"text-align:center;\">".utf8_decode($r[value])."</td><td style=\"text-align:center;\">".utf8_decode($r[text])."</td></tr>";
	echo "</table>";
}
...
if ($ds) renderListValues('Com que idade voc� estava quando aconteceu?', $ds);
...
if ($ds) renderListValues('Religi�o', $ds);
