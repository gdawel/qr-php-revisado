...
class PDF extends FPDFWithHtmlTable
{
    ...
    function ChapterTitle($label, $subtitle = false, $addspaceafter = true, $addspacebefore = true)
    {
        ...
        //Title
        $this->Cell(0, 6, convertIsoUtf($label), 0, 1, 'L', false);
    ...
    function MultiCellBullet($w, $h, $txt, $border = 0, $align = 'J', $fill = false)
    {
	  ...
	  function TableIdentificacao($pesquisa) {     	
        ...
        $this->SetFont('Verdana', '', 8);
        $this->SetTextColor(99);
        $this->Cell(85, 0, 'PROJETO', 0, 0);
	
		$this->Ln(2);
        $this->Cell($l);
        $this->SetFont('Verdana', '', 10);
        $this->SetTextColor(0);
        $this->MultiCell(100, 5, convertIsoUtf($pesquisa->titulo), 0, 1);
        ...
        $this->SetFont('Verdana', '', 8);
        $this->SetTextColor(99);
        $this->Cell(40, 0, convertIsoUtf('DATA DA ELABORAÇÃO'), 0, 1);
        ...
        $this->Cell(40, 9, convertIsoUtf($createddate->format('Y')), 0, 0);

        $this->Cell($l);
        $this->SetFont('Verdana', '', 10);
        $this->SetTextColor(0);
        $this->Cell(40, 9, convertIsoUtf(date("d/m/Y")), 0, 1);        
    }    
}
...
foreach ($pesquisa->modeloquestionario->fatores as $fator) {
    ...
    $pdf->ChapterBody('Tabela do Impacto da Distribuição dos Índices no MCD', 'B');
	 ...
	 $pdf->Cell(50, 0, convertIsoUtf('População: ').$pesquisa->count_concluidos, 0, 1);	 
	 $pdf->Cell(100, 8, convertIsoUtf('Dados da Distribuição dos Índices em %'), 0, 1);
	 	
		//$pdf->Cell(15);
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-P - Condição FRACA'), 0, 0, 'L', true);
		...
		$pdf->Cell(15, 8, convertIsoUtf(number_format($descricaoRelativeValue, 0).'%'), 0, 0, 'C', true);	

		$pdf->Cell(2);	
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-I - Condição FORTE'), 0, 0, 'L', true);		
		$pdf->SetFillColor(240);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-P - Condição MODERADA'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		...
		$pdf->Cell(2);	
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-I - Condição BOA'), 0, 0, 'L', true);		
		$pdf->SetFillColor(240);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-P - Condição BOA'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		...
		$pdf->Cell(2);	
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-I - Condição MODERADA'), 0, 0, 'L', true);		
		$pdf->SetFillColor(240);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-P - Condição FORTE'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		...
		$pdf->Cell(2);	
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-I - Condição FRACA'), 0, 0, 'L', true);		
		$pdf->SetFillColor(240);
		...
		$pdf->Cell(30); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('PC-E - EQUILÍBRIO'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		...
		$pdf->SetFont('Arial', '', 10);
	 	...
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('Valor Mínimo nos Índices'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$pdf->Cell(15, 8, convertIsoUtf($pesquisa->getValorMinimoByFator($fator->id)), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('Amplitude nos Índices'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$pdf->Cell(15, 8, convertIsoUtf($pesquisa->getAmplitudeByFator($fator->id)), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('Valor Máximo nos Índices'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$pdf->Cell(15, 8, convertIsoUtf($pesquisa->getValorMaximoByFator($fator->id)), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('Mdn'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$pdf->Cell(15, 8, convertIsoUtf($pesquisa->getMedianaByFator($fator->id)), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('s²(Var)'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$variance = $pesquisa->getVarianceByFator($fator->id);
		$pdf->Cell(15, 8, convertIsoUtf(($variance)? number_format($variance, 2) : '-'), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);        
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('GL'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$gl = $pesquisa->getGrausDeLiberdadeByFator($fator->id);
		$pdf->Cell(15, 8, convertIsoUtf($gl), 0, 0, 'C', true);
		...
		//$pdf->Cell(15); 
	 	$pdf->SetFillColor(245);
	  	$pdf->SetTextColor(0);
		$pdf->SetFont('Verdana', '', 9);
		$pdf->Cell(55, 8, convertIsoUtf('s (DP da Var)'), 0, 0, 'L', true);
		$pdf->SetFillColor(240);
		$dp = $pesquisa->getStandardDeviationByFator($fator->id);
		$pdf->Cell(15, 8, convertIsoUtf(($dp) ? number_format($dp, 2) : '-'), 0, 0, 'C', true);		
...
$fileName = $pesquisa->id . '_' . convertIsoUtf($pesquisa->titulo) . 
                convertIsoUtf(' - Análise Quantitativa do Grupo.pdf');
